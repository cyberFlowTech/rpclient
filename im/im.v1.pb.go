...
var file_define_im_v1_proto_rawDesc = []byte{
	...
	0x72, 0x2a, 0x1f, 0x0a, 0x08, 0x43, 0x68, 0x61, 0x74, 0x54, 0x79, 0x70, 0x65, 0x12, 0x08, 0x0a,
	0x04, 0x55, 0x73, 0x65, 0x72, 0x10, 0x00, 0x12, 0x09, 0x0a, 0x05, 0x47, 0x72, 0x6f, 0x75, 0x70,
	0x10, 0x01, 0x32, 0xfd, 0x01, 0x0a, 0x08, 0x49, 0x6d, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12,
	...
	0x65, 0x73, 0x42, 0x05, 0x5a, 0x03, 0x2f, 0x69, 0x6d, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_define_im_v1_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_define_im_v1_proto_goTypes = []interface{}{
	...
	(*GroupInfoMember)(nil),  // 14: im.GroupInfoMember
	nil,                      // 15: im.MsgRes.DataEntry
	nil,                      // 16: im.SystemCmdMsgReq.DataEntry
	nil,                      // 17: im.SendMsgReq.EventDataEntry
	nil,                      // 18: im.GetGroupInfoRes.GroupInfoEntry
	nil,                      // 19: im.GroupInfoMembers.MemberEntry
}
var file_define_im_v1_proto_depIdxs = []int32{
	...
	18, // 9: im.GetGroupInfoRes.GroupInfo:type_name -> im.GetGroupInfoRes.GroupInfoEntry
	12, // 10: im.GroupInfo.Dapp:type_name -> im.GroupInfoDapp
	13, // 11: im.GroupInfo.Members:type_name -> im.GroupInfoMembers
	19, // 12: im.GroupInfoMembers.Member:type_name -> im.GroupInfoMembers.MemberEntry
	11, // 13: im.GetGroupInfoRes.GroupInfoEntry.value:type_name -> im.GroupInfo
	14, // 14: im.GroupInfoMembers.MemberEntry.value:type_name -> im.GroupInfoMember
	1,  // 15: im.ImServer.getToken:input_type -> im.GetTokenReq
	6,  // 16: im.ImServer.SendPackMsg:input_type -> im.SendPackMsgReq
	7,  // 17: im.ImServer.SendSystemCmdMsg:input_type -> im.SystemCmdMsgReq
	8,  // 18: im.ImServer.SendMsg:input_type -> im.SendMsgReq
	9,  // 19: im.ImServer.GetGroupInfo:input_type -> im.GetGroupInfoReq
