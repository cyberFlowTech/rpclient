...
var file_define_im_v1_proto_rawDesc = []byte{
	...
	0x63, 0x6b, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x4e, 0x69, 0x63, 0x6b, 0x12, 0x16,
	0x0a, 0x06, 0x41, 0x76, 0x61, 0x74, 0x61, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06,
	0x41, 0x76, 0x61, 0x74, 0x61, 0x72, 0x2a, 0x1f, 0x0a, 0x08, 0x43, 0x68, 0x61, 0x74, 0x54, 0x79,
	0x70, 0x65, 0x12, 0x08, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x10, 0x00, 0x12, 0x09, 0x0a, 0x05,
	0x47, 0x72, 0x6f, 0x75, 0x70, 0x10, 0x01, 0x32, 0xfd, 0x01, 0x0a, 0x08, 0x49, 0x6d, 0x53, 0x65,
	...
	0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73, 0x42, 0x05, 0x5a, 0x03, 0x2f, 0x69, 0x6d, 0x62, 0x06,
...
var file_define_im_v1_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_define_im_v1_proto_goTypes = []interface{}{
	...
	nil,                       // 15: im.MsgRes.DataEntry
	nil,                       // 16: im.SystemCmdMsgReq.DataEntry
	nil,                       // 17: im.SendMsgReq.EventDataEntry
}
var file_define_im_v1_proto_depIdxs = []int32{
	15, // 0: im.MsgRes.Data:type_name -> im.MsgRes.DataEntry
	...
	16, // 5: im.SystemCmdMsgReq.data:type_name -> im.SystemCmdMsgReq.DataEntry
	0,  // 6: im.SendMsgReq.ChatType:type_name -> im.ChatType
	17, // 7: im.SendMsgReq.EventData:type_name -> im.SendMsgReq.EventDataEntry
	...
	2,  // 18: im.ImServer.getToken:output_type -> im.GetTokenRes
	3,  // 19: im.ImServer.SendPackMsg:output_type -> im.MsgRes
	3,  // 20: im.ImServer.SendSystemCmdMsg:output_type -> im.MsgRes
	3,  // 21: im.ImServer.SendMsg:output_type -> im.MsgRes
	10, // 22: im.ImServer.GetGroupInfo:output_type -> im.GetGroupInfoRes
